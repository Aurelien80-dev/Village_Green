    ...
    <div class="partTwo">
        ...
        <div class="right">
            <div class="form-group row">
                ...
                <div class="col-sm-5 mr-3 champs">
       ...
       <select class="form-control" name='service' id="exampleFormControlSelect2">
        <option selected disabled>Service</option>
        <option>Service commerciale</option> 
        <option>Service gestion de produit</option>
          <option>Service Comptabilites</option>
       </select>
       </div>
